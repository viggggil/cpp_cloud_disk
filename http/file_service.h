...
public:
    ...
    static bool create_folder(const std::string& user, const std::string& rel_path, std::string& err);
    static bool rename_path(const std::string& user, const std::string& old_rel_path, const std::string& new_rel_path, std::string& err);
    static bool move_path(const std::string& user, const std::string& src_rel_path, const std::string& target_dir, std::string& err);
    static std::string list_files_json(const std::string& user, const std::string& rel_dir, int page, int page_size);
    static std::string directory_tree_json(const std::string& user);
...
private:
    ...
    static bool validate_folder_path(const std::string& rel, std::string& err);
